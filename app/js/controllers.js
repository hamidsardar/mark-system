...
app.
    ...
    controller('ModuleController', function($scope, $http) {
    	...
    	function fetch() {
    		$http.get("/controlspan/api.php?module=get_module_list")
    ...
    controller('AddModuleController', function($scope, $http) {

    	function add_module() {
    		$http.post("/controlspan/api.php?module=add_module",{ name : $scope.name, link : $scope.link, icon : $scope.icon })
    			.success(function(response) {
